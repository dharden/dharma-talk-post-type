...
<?php // set up some custom fields and other useful strings
...
$format_class = [];
if ( $youtube_link ) { array_push($format_class, 'format-video'); };
if ( $episode_content ) { array_push($format_class, 'format-audio'); };
...
<article id="post-<?php the_ID(); ?>" <?php post_class($format_class); ?>>
	...
	<div class="entry-content">
		...
		<?php }; ?>
		<?php if ( $talk_description ) echo $talk_description; ?>
